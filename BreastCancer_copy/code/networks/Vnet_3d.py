...
class VNet(nn.Module):
    ...
    def __init__(self, in_channels=1, out_channels=2, elu=True, nll=False):
        super(VNet, self).__init__()
        self.in_tr = InputTransition(in_channels, elu)
        self.down_tr32 = DownTransition(32, 64, 1, elu)
        self.down_tr64 = DownTransition(64, 128, 2, elu)
        self.down_tr128 = DownTransition(128, 256, 3, elu, dropout=True)
        self.down_tr256 = DownTransition(256, 320, 2, elu, dropout=True)
        self.up_tr256 = UpTransition(320, 256, 2, elu, dropout=True)
    ...
    def forward(self, x):
        out16_x1 = self.in_tr(x)
        out32_x2 = self.down_tr32(out16_x1)
        out64_x3 = self.down_tr64(out32_x2)
        out128_x4 = self.down_tr128(out64_x3)
        out256_x5 = self.down_tr256(out128_x4)

        y1 = self.up_tr256(out256_x5, out128_x4)
        y2 = self.up_tr128(y1, out64_x3)
        y3 = self.up_tr64(y2, out32_x2)
        y4 = self.up_tr32(y3, out16_x1)
