...
parser.add_argument("--exp_name", type=str, default='tumor_whole_c1_fold1_resunet', help='experiment name used for save')
...
parser.add_argument("--label_prefix", type=str, default='TumorMask-185', help="label prefix")
