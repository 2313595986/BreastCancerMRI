...
def get_train_eval_test_list(fold_root_path, fold_index=0):
    ...
    eval_index = txt.index('eval:')
    test_index = txt.index('test:')

    train_list = txt[train_index + 1:eval_index]
    eval_list = txt[eval_index + 1:test_index]
