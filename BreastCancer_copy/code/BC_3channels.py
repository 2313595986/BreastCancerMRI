...
class BC(Dataset):
    def __init__(self, case_list, data_root_path, img1_prefix='DCE-C0', img2_prefix='DCE-C1',img3_prefix='Subtraction1',
    ...
    def __getitem__(self, index):
        ...
        volume3_path = os.path.join(self.data_root_path, self.img2_prefix,
                                    self.img2_prefix + '_' + self.case_list[index])
...
class Crop2patchesToTensor(object):
    def __init__(self, output_size, volume_key_1='volume1', volume_key_2='volume2', sub_volume_key='volume3', label_key='label'):
        self.output_size = output_size
        self.volume_key_1 = volume_key_1
        self.volume_key_2 = volume_key_2
        self.sub_volume_key = sub_volume_key
        self.label_key = label_key

    def __call__(self, sample):
        volume1, volume2, sub_volume, label = sample[self.volume_key_1], sample[self.volume_key_2], sample[self.sub_volume_key], sample[self.label_key]
        ...
        sample[self.volume_key_1], sample[self.volume_key_2], sample[self.label_key], sample[self.sub_volume_key] = volume1, volume2, label, sub_volume
        return sample
